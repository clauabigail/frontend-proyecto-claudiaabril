...
const LayoutBase = () => {
  ...
  return (
    <div className="bg-black text-white">
      <section >
       <nav
          class=" bg-blackrelative flex w-full items-center justify-between bg-white shadow-sm shadow-neutral-700/10 dark:bg-neutral-800 dark:shadow-black/30 lg:flex-wrap lg:justify-start"
          data-te-navbar-ref>
          {/*<!-- Container wrapper -->*/}
          <div class=" bg-black flex w-full  items-center justify-between px-6">
