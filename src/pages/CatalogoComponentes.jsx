...
const CatalogoComponentes = () => {
  ...
  return (
    <div className=" flex  absolute mt-6 ml-0  inset-x-2 top-6 z-50">
              ...
              <ul class="space-y-2 font-medium">
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      ...
                      <span class="ms-3">Añadir Nuevo Equipo</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                      ...
                      <span class="flex-1 ms-3 whitespace-nowrap">Componentes</span>
        ...
        <div className="flex">
          <div>
          <img src="./379-AirCoolerPipingAssembly-maincomponent.jpg" alt="" />
          </div>
          <div> 

          
          <Toaster richColors />
          <form className=" grid-flow-row w-96 mx-auto font-black rounded-lg flex  flex-col text-black  gap-3 flex flex-col gap-4 bg-slate-200 p-8 shadow-lg rounded-lg">
          <h1 className="text-center text-xl mb-8 text-black">Detalle</h1>
          <br />
          <ul className='font-medium'>
            <li>
              <div className="text-blue-500">Codigo: 
                  
                  <span className='font-bold '> MA1289</span>
                 
                </div>
                </li>

                <li>
                <div>Fecha de instalacion: 
                  <span className='font-bold'>20/10/2022</span>
                </div>
                </li>

                <div>Nombre de Equipo: 
                  <span className='font-bold'>AIR COOLER ASSEMBLY</span>
                </div>
                ...
                <div>Estado: 
                  <span className='font-bold'>Instalado</span>
                </div>
            </ul>
